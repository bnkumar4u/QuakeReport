...
public final class QueryUtils
{
    ...
    private QueryUtils(){}
        ...
        {
            //creates an empty  Arraylist that we can start aading earthquakes to
            ...
            try
            {
                JSONObject earthquakeJSONObj=new JSONObject(SAMPLE_JSON_RESPONSE);

                JSONArray featuresArray=earthquakeJSONObj.getJSONArray("features");
                ...
                for(int i=0;i<featuresArray.length();i++)
                {
                    ...
                    EarthQuakeData earthQuakeData=new EarthQuakeData(mag,place,time,url);
            ...
            catch (JSONException e)
            {
                ...
                Log.e("QueryUtills","Problem parsing the erthquake JSON results",e);
